...
function Write-Banner {
    ...
    $reset  = [char]27 + '[0m'
    Write-Host ""
    Write-Host "${green},p#G*`"`"TG#GF`"`"*GG#`"`"`"@###`"`"`"```$p#GW`"`"^`"*```$G,${reset}"
    Write-Host "${green}{GGG    Gp    G     GG    GG^      N    @G${reset}"
    Write-Host "${green}@GGG[   G    ]G     GG    Gb  %b        #G${reset}"
    Write-Host "${green}'GGGG   @    #G     GG    GG          ```$GGf${reset}"
    Write-Host "${green} GGGG#  '    LGG          GGGN,      @#,${reset}"
    Write-Host "${green}]GGGb        !GGG   NN   GG#**Wp  '  !G[${reset}"
    Write-Host "${green}'GGGG        #GGG   GG    Gf  'G        ```$G'${reset}"
    Write-Host "${green}@GGGb       1GGGG   GG    GGb            ,#G${reset}"
    Write-Host "${green}@GGGG##G#@GGGGG###GGGG##GGGGGG######G#${reset}"
    Write-Host "${green}   \`%N>\`  \`%NW\`   *\`%NW\`  *\`%NLN*\`${reset}"
    Write-Host ""
